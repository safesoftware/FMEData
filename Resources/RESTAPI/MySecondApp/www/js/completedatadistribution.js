...
$(document).ready(function() {
	  ...
	  dataDist.init({
        server: "<yourServerHost>", //Change this to your FME server name
        token: "<youToken>"     });  //Change this to your FME Server Token
	  });
...
var dataDist = (function () {
  ...
  // privates
  var repository = 'RESTTraining'; //To Customize: Change this to the repository where DataDownloadService.fmw was uploaded
  var workspaceName = 'webapp.bcroads.fmw';  //To Customize: Change this if you changed the file name
  var host;
  var token;
